  ...
  return (
    <form className="data-form nutrition-profile-form" onSubmit={submit}>
      ...
      <div className="nutrition-form-grid">
        ...
        <label><span>Target rate <small>signed kg/week, optional</small></span><input name="targetRateKgPerWeek" type="number" min={-1} max={1} step="0.05" defaultValue={profile?.targetRateKgPerWeek} placeholder="− lose, + gain" /></label>
      </div>
