...
type IconName = "activity" | "agent" | "arrow" | "body" | "calendar" | "check" | "code" | "dumbbell" | "flame" | "note" | "plus" | "shield" | "spark" | "trend" | "trophy" | "user";
...
export function Icon({ name, size = 20 }: { name: IconName; size?: number }) {
  ...
  if (name === "note") return <svg {...shared}><path d="M6 3h9l4 4v14H6Z" /><path d="M15 3v5h4M9 12h6M9 16h6" /></svg>;
